...
export let data = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .setChoices({ name: "Competing", value: "COMPETING" }, { name: "Listening", value: "LISTENING" }, { name: "Playing", value: "PLAYING" }, { name: "Streaming", value: "STREAMING" }, { name: "Watching", value: "WATCHING" })));
